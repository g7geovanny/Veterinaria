...
const NuevoPassword = () => {
    ...
    useEffect(() => {
        ...
        const comprobarToken = async () => {
            ...
            try {
                await axios(`${import.meta.env.VITE_BACKEND_URL}/veterinarios/olvide-password/${token}`)
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const url = `${import.meta.env.VITE_BACKEND_URL}/veterinarios/olvide-password/${token}`;
            const data = await axios.post(url, { password });
            setAlerta({msg: data.data.msg})
